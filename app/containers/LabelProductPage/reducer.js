...
const initialState = fromJS({
  ...
  packs: false,
  count: 0, // 总数量
  pageSize: 50, // 分页大小 (当前页存放于路由地址，使用selector获得)
  name: false,  // 标签
});

function labelProductPageReducer(state = initialState, action) {
  switch (action.type) {
...
export default labelProductPageReducer;
